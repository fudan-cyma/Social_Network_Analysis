...
# loading the dataset
```{r}
setwd('c:/Users/cyma9/Dropbox/SocialNetwork/PJ/')
library(dplyr)
...
plot.igraph(friend_network,layout=layout.fruchterman.reingold, vertex.label.color="black",edge.color="black",edge.width=E(friend_network)$weight,vertex.size = 12, edge.arrow.size=.3,edge.curved=FALSE)
...
plot.igraph(enemy_network,layout=layout.fruchterman.reingold, vertex.label.color="black",edge.color="black",edge.width=E(enemy_network)$weight,vertex.size = 12, edge.arrow.size=.3,edge.curved=FALSE)
